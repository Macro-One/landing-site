...
export const TheBleedingEdge: React.FC = () => {
    return (
        <section className="bg-[#151515] py-32 px-6 border-t border-white/5">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
                ...
                <div className="md:w-1/2 relative">
                    ...
                    <div className="relative border border-white/10 bg-[#0a0a0a] p-8 rounded-xl">
                        {/* Schematic SVG */}
                        <svg className="w-full h-auto text-white/80" viewBox="0 0 400 300" fill="none" stroke="currentColor" strokeWidth="1">
                            {/* Grid Background */}
                            <path d="M0 0h400v300H0z" fill="none" />
                            <path d="M40 0v300 M80 0v300 M120 0v300 M160 0v300 M200 0v300 M240 0v300 M280 0v300 M320 0v300 M360 0v300" stroke="white" strokeOpacity="0.05" />
                            <path d="M0 40h400 M0 80h400 M0 120h400 M0 160h400 M0 200h400 M0 240h400 M0 280h400" stroke="white" strokeOpacity="0.05" />

                            {/* Modular Box Schematic */}
                            <rect x="100" y="100" width="200" height="100" stroke="white" strokeWidth="2" />
                            <line x1="100" y1="100" x2="140" y2="60" stroke="white" />
                            <line x1="300" y1="100" x2="340" y2="60" stroke="white" />
                            <line x1="300" y1="200" x2="340" y2="160" stroke="white" />
                            <rect x="140" y="60" width="200" height="100" stroke="white" strokeWidth="2" strokeDasharray="4 4" />
